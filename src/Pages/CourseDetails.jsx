...
const CourseDetails = () => {
    ...
    useEffect(()=>{
        ...
        // console.log("hello ji ",avgRatings)
        // check above line 
    },[courseDetails])
  ...
  return (
        ...
        <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
          ...
          >
            ...
            <div className="text-md flex flex-wrap items-center gap-2">
              <span className="text-yellow-25">{`${avgRatings}`}</span>
              <RatingStars Review_Count={avgRatings} Star_Size={24} />
    ...
    <section className='px-10'>
        <div>
        <h2  className="text-center mt-10 text-white text-4xl font-semibold  mb-16">Review From Other Learners</h2>
        </div>

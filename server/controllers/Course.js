...
exports.createCourse = async (req, res) => {
	try {
        ...
        if (existingCourse) {
            return res.status(400).json({
                success: false,
                message: "A course with similar details already exists for this instructor",
            });
        }
...
exports.showAllCourse=async(req,res)=>{
    ...
    try{
        ...
        return res.status(500).json({
            success:false,
            message:"Something problem to show all courses",
...
// get all course ka handler function
